...
using OKHOSTING.Sql.ORM.UI.Web.MVC.Models;

namespace OKHOSTING.Sql.ORM.UI.Web.MVC.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("OKHOSTING.Sql.ORM.UI.Web.MVC.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("OKHOSTING.Sql.ORM.UI.Web.MVC.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
