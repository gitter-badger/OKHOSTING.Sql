...
namespace OKHOSTING.Sql
{
	...
	public abstract class SqlDataBase
	{
		...
		protected SqlDataBase(string connectionString)
		{
			...
			{
				throw new ArgumentNullException("connectionString", "Argument can't be null or empty");
			}
		...
		/// <summary>
		/// Returns a native Connection corresponding to the database engine associated
		/// </summary>
		...
		/// Returns a native Command corresponding to the database engine associated
		/// </summary>
		public abstract DbParameter Parse(CommandParameter param);

		/// <summary>
		/// Return the native Adapter corresponding to the database engine associated
		/// </summary>
		...
		/// </summary>
		public delegate void DataBaseOperationEventHandler(SqlDataBase sender, CommandEventArgs DatabaseInteractionArgs);
