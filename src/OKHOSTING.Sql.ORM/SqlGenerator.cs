...
namespace OKHOSTING.Sql.ORM
{
	...
	public abstract class SqlGenerator
	{
		...
		/// </summary>
		public SqlGenerator(SqlGeneratorBase nativeSqlGenerator) 
		{
			NativeSqlGenerator = nativeSqlGenerator;
		}

		#region Properties

		public readonly SqlGeneratorBase NativeSqlGenerator;
		...
		{
			return "SELECT " + AutoIncrementalRetrieveFunction(table) + " AS ID";
		}
		...
		protected abstract Command AutoIncrementalRetrieveFunction(Table table);
		...
		public virtual Command Create(Table table)
		{
			...
			string sql = "CREATE TABLE " + EncloseName(table.Name) + " (";
		...
		/// </returns>
		protected virtual Command Format(SortDirection value)
		{
		...
		/// </example>
		protected virtual Command Format(DbType type)
		{
		...
		/// </example>
		protected virtual Command FormatStringType(int lenght)
		{
		...
		/// </summary>
		protected virtual Command EncloseName(string name)
		{
			return
				NameEncloser_Begin +
				name +
		...
		/// </returns>
		protected virtual Command SelectAggregateColumn(SelectAggregateColumn selectAggregateColumn)
		{
			//Local vars
		...
		/// </returns>
		protected virtual Command Operator(LogicalOperator logicalOperator)
		{
		...
		/// </returns>
		protected virtual Command LogicalExpression(string expressionLeft, string expressionRight, LogicalOperator logicalOperator, bool encloseOnParenthesis)
		{
		...
		/// </returns>
		protected virtual Command EncloseOnParenthesis(string expression)
		{
		...
		/// </returns>
		protected virtual Command EqualityComparison(string comparisonLeft, string comparisonRight, CompareOperator equalityOperator)
		{
			//Local Vars
		...
		/// </returns>
		protected virtual Command ColumnFullName(Column column)
		{
