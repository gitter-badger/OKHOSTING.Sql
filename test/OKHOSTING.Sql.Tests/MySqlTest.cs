...
namespace OKHOSTING.Sql.Tests
{
	...
	public class MySqlTest
	{
        ...
        /// <summary>
        /// Creates 3 tables and uses a Select with 2 joins
        /// </summary>
        [TestMethod]
        public void TablesTest()
        {
            ...
            Delete delete = new Delete();
            delete.Table = leage;
            delete.Where.Add(new ValueCompareFilter() { Column = leage["name"], ValueToCompare = "concacaff", Operator = Data.CompareOperator.Equal });
